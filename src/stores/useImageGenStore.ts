...
- **curiosityFacts** (REQUIRED): Array with exactly ONE real-world educational fun fact thematically related to this scene. This must be GENUINE knowledge — history, science, culture, psychology, nature, technology. If the scene involves a medieval castle, include a fact about real medieval architecture. If it involves space, include real astronomy. Make it surprising, engaging, and educational. Each has: title (catchy hook), fact (2-4 sentences), category.
